...
``	}
	...
	public	function	update(Request	$request, string	$id)
	{
		...
		//	Haal het bestaande cijfer op
		$grade	=	Grade::findOrFail($id);

		//	Controleer of de leraar dit cijfer mag wijzigen.
		if ($grade->teacher->id	!==	auth()->user()->teacher->id) {
			abort(403, "Je mag dit cijfer niet wijzigen");
		}
